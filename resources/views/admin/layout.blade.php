        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">UkraineBus</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{route('trips.index')}}"><i class="fa fa-sticky-note-o"></i> <span>Напрями</span></a></li>
        <li><a href="{{route('passengers.index')}}"><i class="fa fa-sticky-note-o"></i> <span>Пасажири</span></a></li>
